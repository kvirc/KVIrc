...
#define KVI_USERFLAG_IRCOP 64

#define KVI_USERFLAG_MODEMASK (KVI_USERFLAG_USEROP | KVI_USERFLAG_VOICE | KVI_USERFLAG_HALFOP | KVI_USERFLAG_OP | KVI_USERFLAG_CHANADMIN | KVI_USERFLAG_CHANOWNER | KVI_USERFLAG_IRCOP)
