...
/*
void KviTalTreeWidget::redirect_selectionChanged(Q3ListViewItem * pItem)
{
	emit selectionChanged((KviTalTreeWidgetItem *)pItem);
}

void KviTalTreeWidget::redirect_currentChanged(Q3ListViewItem * pItem)
{
	emit currentChanged((KviTalTreeWidgetItem *)pItem);
}

void KviTalTreeWidget::redirect_clicked(Q3ListViewItem * pItem)
{
	emit clicked((KviTalTreeWidgetItem *)pItem);
}

void KviTalTreeWidget::redirect_clicked(Q3ListViewItem * pItem,const QPoint &pnt,int uColumn)
{
	emit clicked((KviTalTreeWidgetItem *)pItem,pnt,uColumn);
}

void KviTalTreeWidget::redirect_pressed(Q3ListViewItem * pItem)
{
	emit pressed((KviTalTreeWidgetItem *)pItem);
}

void KviTalTreeWidget::redirect_pressed(Q3ListViewItem * pItem,const QPoint &pnt,int uColumn)
{
	emit pressed((KviTalTreeWidgetItem *)pItem,pnt,uColumn);
}

void KviTalTreeWidget::redirect_doubleClicked(Q3ListViewItem * pItem)
{
	emit doubleClicked((KviTalTreeWidgetItem *)pItem);
}

void KviTalTreeWidget::redirect_doubleClicked(Q3ListViewItem * pItem,const QPoint &pnt,int uColumn)
{
	emit doubleClicked((KviTalTreeWidgetItem *)pItem,pnt,uColumn);
}

void KviTalTreeWidget::redirect_returnPressed(Q3ListViewItem * pItem)
{
	emit returnPressed((KviTalTreeWidgetItem *)pItem);
}

void KviTalTreeWidget::redirect_spacePressed(Q3ListViewItem * pItem)
{
	emit spacePressed((KviTalTreeWidgetItem *)pItem);
}

void KviTalTreeWidget::redirect_rightButtonClicked(Q3ListViewItem * pItem,const QPoint &pnt,int uColumn)
{
	emit rightButtonClicked((KviTalTreeWidgetItem *)pItem,pnt,uColumn);
}

void KviTalTreeWidget::redirect_rightButtonPressed(Q3ListViewItem * pItem,const QPoint &pnt,int uColumn)
{
	emit rightButtonPressed((KviTalTreeWidgetItem *)pItem,pnt,uColumn);
}

void KviTalTreeWidget::redirect_mouseButtonClicked(int iButton,Q3ListViewItem * pItem,const QPoint &pnt,int uColumn)
{
	emit mouseButtonClicked(iButton,(KviTalTreeWidgetItem *)pItem,pnt,uColumn);
}

void KviTalTreeWidget::redirect_mouseButtonPressed(int iButton,Q3ListViewItem * pItem,const QPoint &pnt,int uColumn)
{
	emit mouseButtonPressed(iButton,(KviTalTreeWidgetItem *)pItem,pnt,uColumn);
}

void KviTalTreeWidget::redirect_contextMenuRequested(Q3ListViewItem * pItem,const QPoint &pnt,int uColumn)
{
	emit contextMenuRequested((KviTalTreeWidgetItem *)pItem,pnt,uColumn);
}

void KviTalTreeWidget::redirect_onItem(Q3ListViewItem * pItem)
{
	emit onItem((KviTalTreeWidgetItem *)pItem);
}

void KviTalTreeWidget::redirect_expanded(Q3ListViewItem * pItem)
{
	emit expanded((KviTalTreeWidgetItem *)pItem);
}

void KviTalTreeWidget::redirect_collapsed(Q3ListViewItem * pItem)
{
	emit collapsed((KviTalTreeWidgetItem *)pItem);
}
...
: KviTalTreeWidgetItem(parent, text, QString())
{
	myType = tt;
	init();
...
KviTalCheckListItem::KviTalCheckListItem(KviTalCheckListItem *parent, KviTalTreeWidgetItem *after,const QString &text, Type tt)
: KviTalTreeWidgetItem(parent, after, text)
{
	myType = tt;
	init();
	if (myType == RadioButton) {
...
KviTalCheckListItem::KviTalCheckListItem(KviTalTreeWidgetItem *parent, const QString &text,Type tt)
: KviTalTreeWidgetItem(parent, text, QString())
{
	myType = tt;
	if (myType == RadioButton) {
...
KviTalCheckListItem::KviTalCheckListItem(KviTalTreeWidgetItem *parent, KviTalTreeWidgetItem *after,const QString &text, Type tt)
: KviTalTreeWidgetItem(parent, after, text)
{
	myType = tt;
	if (myType == RadioButton) {
...
KviTalCheckListItem::KviTalCheckListItem(KviTalTreeWidget *parent, const QString &text,Type tt)
: KviTalTreeWidgetItem(parent, text)
{
	myType = tt;
	if (tt == RadioButton){
		qWarning("KviTalCheckListItem::KviTalCheckListItem(), radio button must be "
...
KviTalCheckListItem::KviTalCheckListItem(KviTalTreeWidget *parent, KviTalTreeWidgetItem *after,const QString &text, Type tt)
: KviTalTreeWidgetItem(parent, after, text)
{
	myType = tt;
	if (tt == RadioButton){
...
KviTalCheckListItem::KviTalCheckListItem(KviTalTreeWidget *parent, const QString &text,const QPixmap & p)
: KviTalTreeWidgetItem(parent, text)
{
...
KviTalCheckListItem::KviTalCheckListItem(KviTalTreeWidgetItem *parent, const QString &text,const QPixmap & p)
: KviTalTreeWidgetItem(parent, text)
{
	myType = RadioButtonController;
	setPixmap(0, p);
...
void KviTalCheckListItem::setState(ToggleState s, bool update, bool store)
{
	...
	if (update && parent() && parent()->rtti() == 1
		...
		if (s == NoChange && childCount()) {
			...
			KviTalTreeWidgetItem *item = firstChild();
			int childCount = 0;
			while(item) {
				if (item->rtti() == 1 &&
...
int KviTalCheckListItem::width(const QFontMetrics& fm, const KviTalTreeWidget* lv, int column) const
{
	int r = KviTalTreeWidgetItem::width(fm, lv, column);
	if (column == 0) {
		r += lv->itemMargin();
...
void KviTalCheckListItem::paintCell(QPainter * p, const QColorGroup & cg, int column, int width, int align)
{
	...
	KviTalTreeWidgetItem::paintCell(p, cg, column, width - r, align);
}
	...
	if (myType != RadioButtonController && intersect &&
		...
		if (lv->columnAlignment(0) == Qt::AlignCenter) {
			...
			rect.setRect(r.x() + boxsize + 5, r.y(), r.width() - boxsize - 5,
					r.height());
		KviTalTreeWidgetItem::paintFocus(p, cg, rect);
	} else {
		KviTalTreeWidgetItem::paintFocus(p, cg, r);
	}
}
