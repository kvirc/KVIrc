...
QString KviTreeWindowListItem::currentCaption() const
{
	QString szText;
...
bool KviTreeWindowList::eventFilter(QObject * o,QEvent *e)
{
	if(o == m_pTreeWidget->viewport())
	{
		if(e->type() == QEvent::MouseButtonPress)
		{
			...
			KviTreeWindowListItem * it = (KviTreeWindowListItem *)m_pTreeWidget->itemAt(ev->pos());
			if(!it)return false;
