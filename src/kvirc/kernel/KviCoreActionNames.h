...
#define KVI_COREACTION_CLASSEDITOR (KVI_COREACTION_NAME_PREFIX "classeditor")
...
#define KVI_COREACTION_FILETRANSFER (KVI_COREACTION_NAME_PREFIX "filetransfer")
#define KVI_COREACTION_IOGRAPH (KVI_COREACTION_NAME_PREFIX "iograph")
#define KVI_COREACTION_LOGVIEWER (KVI_COREACTION_NAME_PREFIX "logviewer")
#define KVI_COREACTION_SHAREDFILES (KVI_COREACTION_NAME_PREFIX "sharedfiles")
#define KVI_COREACTION_URLLIST (KVI_COREACTION_NAME_PREFIX "urllist")
