...
#define KVI_INTERNALCOMMAND_OPENURL_KVIRC_MAILINGLIST 22
#define KVI_INTERNALCOMMAND_OPENURL_KVIRC_BUGTRACK 23
#define KVI_INTERNALCOMMAND_RAWEDITOR_OPEN 24              // Unused
#define KVI_INTERNALCOMMAND_POPUPEDITOR_OPEN 25            // Unused
#define KVI_INTERNALCOMMAND_EXECUTE_SCRIPT_FROM_DISK 26    // Unused
#define KVI_INTERNALCOMMAND_ACTIONEDITOR_OPEN 27           // Unused
#define KVI_INTERNALCOMMAND_QUIT 28
#define KVI_INTERNALCOMMAND_KVIRC_HOMEPAGE_RU 29
#define KVI_INTERNALCOMMAND_JOIN_KVIRC_ON_FREENODE 30

#define KVI_NUM_INTERNAL_COMMANDS 31
