...
#define KVI_INTERNALCOMMAND_JOIN_KVIRC_ON_FREENODE 34
#define KVI_INTERNALCOMMAND_JOIN_KVIRC_IT_ON_AZZURRA 35
#define KVI_INTERNALCOMMAND_KVIRC_HOMEPAGE_FR 36
#define KVI_INTERNALCOMMAND_JOIN_KVIRC_FR_ON_FREENODE 37
#define KVI_INTERNALCOMMAND_JOIN_KVIRC_FR_ON_EUROPNET 38

#define KVI_NUM_INTERNAL_COMMANDS 39
