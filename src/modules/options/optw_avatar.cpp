...
: KviOptionsWidget(parent,"avatar_advanced_options_widget")
{
	...
	// 1st Box
	QGroupBox *g = addGroupBox(0,0,0,0,1,QGroupBox::Horizontal,__tr2qs_ctx("Scaling","options"));
	...
	// 2st Box
	QGroupBox *gs = addGroupBox(0,1,0,1,1,QGroupBox::Horizontal,__tr2qs_ctx("Request CTCP","options"));
