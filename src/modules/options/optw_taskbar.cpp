...
: KviOptionsWidget(parent,"treetaskbar_options_widget")
{
	...
	QGroupBox *g = addGroupBox(0,0,0,0,2,QGroupBox::Horizontal,__tr2qs_ctx("Text/Alert Colors","options"));
...
: KviOptionsWidget(parent,"treetaskbar_options_widget")
{
	...
	QGroupBox * g = addGroupBox(0,0,1,0,2,QGroupBox::Horizontal,__tr2qs_ctx("Background Colors","options"));
...
: KviOptionsWidget(parent,"classictaskbar_options_widget")
{
	...
	QGroupBox *g = addGroupBox(0,1,0,1,2,QGroupBox::Horizontal,__tr2qs_ctx("Text/Alert Colors","options"));
