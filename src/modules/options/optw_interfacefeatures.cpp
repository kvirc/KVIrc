...
: KviOptionsWidget(parent,"interfacefeatures_options_widget")
{
	...
	addBoolSelector(0,0,0,0,__tr2qs_ctx("Close in tray","options"),KviOption_boolCloseInTray);
	addBoolSelector(0,1,0,1,__tr2qs_ctx("Minimize in tray","options"),KviOption_boolMinimizeInTray);
	addBoolSelector(0,1,0,1,__tr2qs_ctx("Minimize on startup","options"),KviOption_boolStartupMinimized);
	addBoolSelector(0,3,0,3,__tr2qs_ctx("Confirm quit with active connections","options"),KviOption_boolConfirmCloseWhenThereAreConnections);
	addBoolSelector(0,4,0,4,__tr2qs_ctx("Remember window properties","options"),KviOption_boolWindowsRememberProperties);
	...
	addWidgetToLayout(m_pDisableSplash,0,5,0,5);
	m_pDisableSplash->setChecked(bDisableSplash);
	
	addBoolSelector(0,6,0,6,__tr2qs_ctx("Enable visual effects","options"),KviOption_boolEnableVisualEffects);
	addBoolSelector(0,7,0,7,__tr2qs_ctx("Hide Channel window tool buttons by default","options"),KviOption_boolHideWindowToolButtons);
	
	QGroupBox * g = addGroupBox(0,8,0,8,1,QGroupBox::Horizontal,__tr2qs_ctx("Open Dialog Window For","options"));
