...
KVSO_BEGIN_REGISTERCLASS(KviKvsObject_widget,"widget","object")
	...
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,update)

	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,repaint)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,isTopLevel)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,isVisible)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,raise)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,lower)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setEnabled)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,isEnabled)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setMouseTracking)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setWindowTitle)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setWindowTitle)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,windowTitle)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,windowTitle)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,hasFocus)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setFocus)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setToolTip)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setWFlags)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setWindowIcon)
	// fonts
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,fontDescent)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,fontAscent)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,fontMetricsWidth)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,fontMetricsHeight)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setFont)
	// geometry
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,screenResolution)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,centerToScreen)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,geometry)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setGeometry)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,mapToGlobal)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,mapFromGlobal)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,y)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,x)

	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,globalCursorX)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,globalCursorY)

	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,width)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,height)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setMinimumWidth)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setMinimumHeight)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setMaximumWidth)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setMaximumHeight)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,move)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,sizeHint)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,resize)

	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setFocusPolicy)
	...
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,foregroundColor)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setMask)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setAttribute)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,colorPalette)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setStyleSheet)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,setKeyShortcut)

	// statusbar
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,insertIntoStatusBar)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_widget,removeFromStatusBar)
	// events
