...
KVSO_BEGIN_REGISTERCLASS(KviKvsObject_list,"list","object")
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,count)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,isEmpty)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,clear)
	KVSO_REGISTER_HANDLER(KviKvsObject_list,"removeAll",clear)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,append)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,prepend)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,insert)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,insert)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,at)
	KVSO_REGISTER_HANDLER(KviKvsObject_list,"item",at)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,remove)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,removeFirst)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,removeLast)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,removeCurrent)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,moveFirst)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,moveNext)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,movePrev)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,moveLast)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,sort)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,eof)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_list,current)
