...
#define urlLabelFuncReg(__nam, __func) \
	...
	(KviScriptObjectFunctionHandlerProc)(KVI_PTR2MEMBER(KviScriptUrlLabelObject::__func)),\
	0, true);

void KviScriptUrlLabelObject::registerSelf()
{
...
void KviScriptUrlLabelObject::unregisterSelf()
{
	delete g_pUrlLabelClass;
    g_pUrlLabelClass = 0;
}

bool KviScriptUrlLabelObject::functionSetUrl(KviCommand * c, KviParameterList * p, \
	KviStr & b)
{
	if(!widget())
		return true;

	ENTER_STACK_FRAME(c, "urllabel::setUrl");
...
bool KviScriptUrlLabelObject::functionUrl(KviCommand * c, KviParameterList * p, \
	KviStr & b)
{
	b.append(m_url);
	return true;
...
bool KviScriptUrlLabelObject::functionSetAction(KviCommand * c, KviParameterList * p,\
	KviStr & b)
{
	if(!widget())
		return true;

	ENTER_STACK_FRAME(c, "urllabel::setAction");
...
bool KviScriptUrlLabelObject::functionAction(KviCommand * c, KviParameterList * p,
	KviStr & b)
{
	b.append(m_action);
	return true;
...
bool KviScriptUrlLabelObject::functionSetText(KviCommand * c, KviParameterList * p, \
	KviStr & b)
{
	if(widget())
	{
...
bool KviScriptUrlLabelObject::functionSetCursorChange(KviCommand * c, \
...
bool KviScriptUrlLabelObject::functionCursorChange(KviCommand * c, \
	KviParameterList * p, KviStr & b)
{
...
bool KviScriptUrlLabelObject::functionSetUseSingleClick(KviCommand * c, \
	KviParameterList * p, KviStr & b)
{
...
bool KviScriptUrlLabelObject::functionUseSingleClick(KviCommand * c, \
	KviParameterList * p, KviStr & b)
{
