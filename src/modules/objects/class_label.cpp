...
KVSO_BEGIN_REGISTERCLASS(KviKvsObject_label,"label","widget")
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_label,setText)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_label,text)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_label,margin)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_label,setMargin)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_label,alignment)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_label,setAlignment)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_label,clear)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_label,frameStyle)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_label,setFrameStyle)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_label,setImage)
