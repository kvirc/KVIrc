...
KVSO_BEGIN_REGISTERCLASS(KviKvsObject_lineedit,"lineedit","widget")
	...
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,setCursorPosition)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,cursorPosition)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,setFrame)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,selectAll)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,setSelection)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,copy)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,cut)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,paste)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,echoMode)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,setEchoMode)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,clear)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,dragAndDrop)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,setInputMask)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,setReadOnly)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,returnPressedEvent)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,lostFocusEvent)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,textChangedEvent)
	KVSO_REGISTER_HANDLER_BY_NAME(KviKvsObject_lineedit,setInputValidator)
