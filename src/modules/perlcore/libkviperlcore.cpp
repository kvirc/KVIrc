...
static QDict<KviPerlInterpreter> * g_pInterpreters = 0;
...
{
	QDictIterator<KviPerlInterpreter> it(*g_pInterpreters);
...
{
#ifdef COMPILE_PERL_SUPPORT
	g_pInterpreters = new QDict<KviPerlInterpreter>(17,false);
