...
void RawEditorWidget::exportCurrentHandler()
{
	...
	{
		QMessageBox::warning(this,__tr2qs_ctx("Write to File Failed - KVIrc","editor"),__tr2qs_ctx("Unable to write to the RAW events file.","editor"),__tr2qs_ctx("&OK","editor"));
	}
}
